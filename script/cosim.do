...
quietly set CFG_DIR "${PR_DIR}/simu/cosim/conf/${MODEL_BOARD}"
...
proc run_utest {args} {
   ...
   if {[llength $args] == 0} {
      ...
      foreach nb_file $args {
         ...
         add wave -format Logic                    -group "Local Resets"                        sim/:top_dmx_tb:I_top_dmx_dm:G_column_mgt(0):I_squid_adc_mgt:i_rst_sqm_adc_dac
         add wave -format Logic                    -group "Local Resets"                        sim/:top_dmx_tb:I_top_dmx_dm:G_column_mgt(1):I_squid_adc_mgt:i_rst_sqm_adc_dac
         add wave -format Logic                    -group "Local Resets"                        sim/:top_dmx_tb:I_top_dmx_dm:G_column_mgt(2):I_squid_adc_mgt:i_rst_sqm_adc_dac
         add wave -format Logic                    -group "Local Resets"                        sim/:top_dmx_tb:I_top_dmx_dm:G_column_mgt(3):I_squid_adc_mgt:i_rst_sqm_adc_dac
         add wave -format Logic                    -group "Local Resets"                        sim/:top_dmx_tb:I_top_dmx_dm:G_column_mgt(0):I_sqm_dac_mgt:i_rst_sqm_adc_dac
         add wave -format Logic                    -group "Local Resets"                        sim/:top_dmx_tb:I_top_dmx_dm:G_column_mgt(1):I_sqm_dac_mgt:i_rst_sqm_adc_dac
         add wave -format Logic                    -group "Local Resets"                        sim/:top_dmx_tb:I_top_dmx_dm:G_column_mgt(2):I_sqm_dac_mgt:i_rst_sqm_adc_dac
         add wave -format Logic                    -group "Local Resets"                        sim/:top_dmx_tb:I_top_dmx_dm:G_column_mgt(3):I_sqm_dac_mgt:i_rst_sqm_adc_dac
         add wave -format Logic                    -group "Local Resets"                        sim/:top_dmx_tb:I_top_dmx_dm:G_column_mgt(0):I_sqa_dac_mgt:i_rst_sqm_adc_dac
         add wave -format Logic                    -group "Local Resets"                        sim/:top_dmx_tb:I_top_dmx_dm:G_column_mgt(1):I_sqa_dac_mgt:i_rst_sqm_adc_dac
         add wave -format Logic                    -group "Local Resets"                        sim/:top_dmx_tb:I_top_dmx_dm:G_column_mgt(2):I_sqa_dac_mgt:i_rst_sqm_adc_dac
         add wave -format Logic                    -group "Local Resets"                        sim/:top_dmx_tb:I_top_dmx_dm:G_column_mgt(3):I_sqa_dac_mgt:i_rst_sqm_adc_dac
